...
class HomePage {
    constructor() {
        ...
        this.ShopOption = Selector('#nclood-nav > div.top-nav-container.pin.expanded > nav > ul > li.nav-gamestore.active.highlight > div > div.expanded-nav-gamestore.active > div > div > a:nth-child(1) > div').withText('Shop games');
